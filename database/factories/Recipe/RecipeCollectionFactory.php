...
//        $imageFile = new File($image);
        ...
        return [
            'parent_collection_id' => ParentCollection::inRandomOrder()->first()->id,
            'name' => $name = $this->faker->foodName(),
            'slug' => $name,
            'description' => $this->faker->text,
            'main_image' => 'test_image',
//            'main_image' => Storage::disk('public')->putFile('recipe_collection/images', $imageFile),
            'main_image_thumbnail' => 'test_image',
//            'main_image_thumbnail' => Storage::disk('public')->putFile('recipe_collection/images/thumbnails', $imageFile),
            'banner_image' => 'test_image',
//            'banner_image' => Storage::disk('public')->putFile('recipe_collection/images/banner', $imageFile),
